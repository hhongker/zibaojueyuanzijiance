...
def residual_conv(prev, level, pad=1, lvl=1, sub_lvl=1, modify_stride=False):
    lvl = str(lvl)
    sub_lvl = str(sub_lvl)
    names = ["Res_conv" + lvl + "_" + sub_lvl + "_1x1_reduce",
             "Res_conv" + lvl + "_" + sub_lvl + "_1x1_reduce_bn",
             "Res_conv" + lvl + "_" + sub_lvl + "_3x3",
             "Res_conv" + lvl + "_" + sub_lvl + "_3x3_bn",
             "Res_conv" + lvl + "_" + sub_lvl + "_1x1_increase",
             "Res_conv" + lvl + "_" + sub_lvl + "_1x1_increase_bn"]
...
def short_convolution_branch(prev, level, lvl=1, sub_lvl=1,
    ...
    lvl = str(lvl)
    sub_lvl = str(sub_lvl)
    names = ["Res_conv" + lvl + "_" + sub_lvl + "_1x1_proj",
             "Res_conv" + lvl + "_" + sub_lvl + "_1x1_proj_bn"]
...
def ResNet(inp, layers):
    ...
    names = ["Res_conv1_1_3x3_s2",
             "Res_conv1_1_3x3_s2_bn",
             "Res_conv1_2_3x3",
             "Res_conv1_2_3x3_bn",
             "Res_conv1_3_3x3",
             "Res_conv1_3_3x3_bn"]
...
def interp_block(prev_layer, level, feature_map_shape, input_shape):
    ...
    names = [
        "PSP_conv5_3_pool" + str(level) + "_conv",
        "PSP_conv5_3_pool" + str(level) + "_conv_bn"
    ]
...
def _build_pspnet(nb_classes, resnet_layers, input_shape,
                  activation='softmax',freeze_encoder=True):
    ...
    # ResNet的权重固定不用训练 
#    if freeze_encoder:
#       res.trainable = False # 无效，只控制了第一层
